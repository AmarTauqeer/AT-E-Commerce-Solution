...
import CategoryAddEditForm from "./category-add-update-form";
...
export function CategoryAddOrUpdateDialog({ data }: receiveDataType) {
    const router = useRouter()
    const currentDate = new Date()
    let { id, category_name, created_at } = data;
        ...
        <Dialog open={isOpen} onOpenChange={handleOnchage}>
            <form>
                ...
                <DialogContent className="sm:max-w-175">
                    ...
                    <CategoryAddEditForm data={{
                        id: id, category_name: category_name, created_at: created_at
                    }} setIsOpen={setIsOpen} />
                </DialogContent>
